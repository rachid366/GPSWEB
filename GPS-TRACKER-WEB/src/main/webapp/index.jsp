	...
	$(document).ready(function() {
		...
		checkbox.click(function() {
			...
			if (itemId == val) {
				...
				$('#vitesse').val('<c:out value="${v.getVitesse()}"/>')
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-sm-6">
							<a href="#addEmployeeModal" class="btn btn-outline-dark"
						...
						<div class="modal-content">
							<form action="VehiculeServlet?action=doAdd" method="post">
								...
								<div class="modal-body">
									...
									<div class="form-group">
										<label>Vitesse</label> <input type="text" name="vitesse"
											class="form-control" required>
									</div>
								</div>
						...
						<div class="modal-content">
							<form action="VehiculeServlet?action=doUpdate" method="post">
								...
								<div class="modal-body">
									...
									<div class="form-group">
										<label>Vitesse</label> <input type="text" name="vitesse"
											class="form-control" id="vitesse" required>
									</div>
								</div>
								<div class="modal-footer">
									<input type="button" class="btn btn-default"
